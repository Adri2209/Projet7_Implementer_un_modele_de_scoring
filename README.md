...
- Mettre en œuvre une **approche MLOps complète** :
...
- des agrégations issues de plusieurs tables liées (application, bureau, POS_CASH, etc.).
...
🌐 [API en ligne sur Azure](https://implementer-un-modele-de-scoring-b6fwe6eegaamhkdh.francecentral-01.azurewebsites.net/)
...
Les autres endpoints (comme `/prediction` ou `/client_info/<id>`) seront ajoutés ultérieurement.
...
✅ **Résultat :** 11 tests passés avec succès — *0 failed* ✅
